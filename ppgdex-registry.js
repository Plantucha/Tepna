...
(function (global) {
  ...
  var PPG_REGISTRY = {
    ...
    spo2wMedian: { label: 'SpO₂w median', unit: '%', goodDirection: 'up', depth: 'advanced', evidence: 'experimental', cite: 'Waveform-derived SpO₂ trend median — 0x05 ratio-of-ratios, per-session self-calibrated vs device SpO₂' },
    spo2wMin: { label: 'SpO₂w min', unit: '%', goodDirection: 'up', depth: 'advanced', evidence: 'experimental', cite: 'Waveform-derived SpO₂ trend minimum — same channel; extremes compressed by the regression' },
    spo2wTrackR: { label: 'SpO₂w track r', unit: '', goodDirection: 'up', depth: 'advanced', evidence: 'experimental', cite: 'Pearson r of the waveform ratio vs device SpO₂ this session — the self-calibration quality gate (≥0.3 required)' },

...
**Status:** DONE — 2026-09-20 (§3 ruled and executed 2026-09-17 per queue D3 — mean, `hrStat` in `ppgdex-dsp.js`; all three Done-when items ticked. Verified 2026-09-20) · **Residue:** 2026-09-17-no-fixture-expresses-epoch-hrstat · **Created:** 2026-08-04 · **Spawned-by:** `R5-HR-TRIPLET-REFERENCE-2026-07-12-BRIEF.md` (bias item, executed) · **Affects:** every cross-node HR comparison — `oxydex-dsp.js` `oxyBuildEpochSeries`, `ecgdex-dsp.js` epoch builder, the HR three-cornered hat

...
**Status:** IN-PROGRESS — 2026-09-20 (NOT owner-blocked: D1 ruled 2026-09-19. The one open item — byte-level parity fixture against the JS recompute — waits on WU-6 shipping its plant, which is fleet work, not a decision) · **Created:** 2026-09-06 · **Residue:** 2026-09-06-warmup-verdict-goes-stale, 2026-09-06-t-stuck-validated-on-ring-only

...
(function (global) {
  ...
  var OXY_REGISTRY = {
    ...
    peakCycSec: { label: 'FFT Cycle Length', unit: 's', goodDirection: 'neutral', depth: 'research', evidence: 'experimental', cite: 'Periodogram peak converted to a period, gated by a fitted-background significance test; null when no peak clears it' },
    peakFreqHz: { label: 'FFT Peak Freq', unit: 'Hz', goodDirection: 'neutral', depth: 'research', evidence: 'experimental', cite: 'Dominant SpO2 frequency (DFT), same significance gate as FFT Cycle Length' },

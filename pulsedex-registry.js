...
(function (global) {
  ...
  var PULSE_REGISTRY = {
    ...
    hf: { label: 'HF Power', unit: 'ms²', goodDirection: 'up', depth: 'advanced', evidence: 'validated', cite: 'HF power — parasympathetic (Task Force 1996) · Parseval calibration corrected 2026-07-19 (DEEP-AUDIT-II §3.1): the scale factor previously divided the FULL-signal variance by the IN-BAND integral, folding out-of-band power into this band' },
    lf: { label: 'LF Power', unit: 'ms²', goodDirection: 'up', depth: 'research', evidence: 'validated', cite: 'LF power (Task Force 1996) · Parseval calibration corrected 2026-07-19 (DEEP-AUDIT-II §3.1): the scale factor previously divided the FULL-signal variance by the IN-BAND integral, folding out-of-band power into this band' },
    vlf: { label: 'VLF Power', unit: 'ms²', goodDirection: 'up', depth: 'research', evidence: 'validated', cite: 'VLF power (Task Force 1996) · Parseval calibration corrected 2026-07-19 (DEEP-AUDIT-II §3.1): the scale factor previously divided the FULL-signal variance by the IN-BAND integral, folding out-of-band power into this band' },

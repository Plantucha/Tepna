...
var PULSE_LABEL_ALIAS = {
  'pulse hr':'hr', 'mean hr':'hr', 'mean hr (med)':'hr', 'hr':'hr',
  'mean rr':'meanRR', 'median rr':'medianRR', 'min rr':'minRR', 'max rr':'maxRR',
  'q1 (25th)':'q25', 'q3 (75th)':'q75', 'nn50':'nn50', 'mode':'modeRR', 'amo50':'amo50',
  'mxdmn':'mxdmn', 'cv':'cv', 'n (beats)':'nBeats', 'coverage':'coverage', 'artifacts':'artifacts',
  'sdnn':'sdnn', 'sdnn (med)':'sdnn', 'rmssd':'rmssd', 'rmssd (med)':'rmssd',
  'ln rmssd':'lnRMSSD', 'ln(rmssd)':'lnRMSSD', 'lnrmssd':'lnRMSSD',
  'pnn50':'pnn50', 'pnn50 (med)':'pnn50',
  'sdann':'sdann', 'sdnn index':'sdnnIdx', 'tri index':'triIdx',
  'total power':'tp', 'total pwr':'tp', 'hf power':'hf', 'hf':'hf',
  'lf power':'lf', 'lf':'lf', 'vlf power':'vlf', 'lf/hf':'lfhf',
  /* ANS-activation bar labels — composite scores, not the spectral powers (HF/LF resolve above) */
  'sns':'ansSns', 'psns':'ansPsns',
  'hf n.u.':'hfnu', 'hf nu':'hfnu', 'lf nu':'lfnu',
  'sd1':'sd1', 'sd2':'sd2', 'sd1/sd2':'sd1sd2', 'ellipse area':'ellArea',
  'baevsky si':'si',
  'dfa α1':'dfaAlpha1', 'dfa a1':'dfaAlpha1', 'sampen':'sampen',
  'decel cap':'decelCap', 'accel cap':'accelCap', 'rsa proxy':'rsaProxy',
  'resp rate':'respRate', 'vagal eff':'vagalEff', 'sdnn z':'sdnnZ',
  'pip':'pip', 'ials':'ials', 'pss':'pss', 'pas':'pas',
  'hrv score':'hrvScore', 'stress':'stress', 'stress est':'stress',
  'energy':'energy', 'energy est':'energy', 'focus est':'focus', 'coherence':'coherence',
  'recovery':'recovery', 'recov index':'recovIndex',
  'ans sns':'ansSns', 'ans psns':'ansPsns', 'sns bal':'snsBal', 'psns bal':'psnsBal',
  'abs':'abs', 'efc ready':'efc', 'efc readiness':'efc', 'cardiac crs':'crs',
  'stress-focus':'sfg', 'focus effic':'fe', 'pns effic':'pnse', 'otr':'otr',
  'htn pattern':'htn', 'health':'health',
  'vo₂max est':'vo2', 'vo2max est':'vo2',
  'vo₂ adj':'vo2', 'vo2 adj':'vo2', 'vo₂ base':'vo2base', 'vo2 base':'vo2base'
};
...
var _META_DENY = { 'date':1, 'datetime':1, 'start':1, 'end':1, 'source':1, 'sample rate':1,
  'recording':1, 'duration':1, 'mode':0, 'active flags':1, 'vo₂ gt':1, 'vo2 gt':1,
  '— advanced / research —':1 };
...
global.PulseRegistry = {
  REGISTRY: PULSE_REGISTRY, ALIAS: PULSE_LABEL_ALIAS,

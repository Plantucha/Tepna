...
var HRV_REGISTRY = {
  ...
  welfare:   { label:'Restoration Index', unit:'', goodDirection:'up',   depth:'research', evidence:'heuristic', cite:'Energy×Coherence/Stress — composite' },  /* renamed from 'Welfare Idx' 2026-06-23 (DEX-METRIC-REMOVAL-AUDIT 🟡 — neutral autonomic naming) */
  ...
  otr:       { label:'Overtrain Risk',unit:'',   goodDirection:'down', depth:'research', evidence:'heuristic', cite:'SNS/PSNS-load overtraining proxy — internal composite; HRV training-status monitoring per Bellenger 2016 (Sports Med 46:1461), but this specific index is not validated' },
  crs:       { label:'Cardiac Resilience',unit:'',goodDirection:'up',  depth:'research', evidence:'heuristic', cite:'Cardiac-resilience composite (Coherence×rMSSD×pNN50 / Stress) — internal, directional only' },
  focusEff:  { label:'Focus Efficiency',unit:'',  goodDirection:'up',   depth:'research', evidence:'experimental', cite:'Focus/sympathetic-efficiency ratio (focus/(SNS+1)) — internal composite' },
  ...
  ortho:     { label:'Orthostatic Load',unit:'', goodDirection:'down', depth:'research', evidence:'experimental', cite:'HR/SDNN autonomic-load proxy — internal; NOT a true supine→stand orthostatic test' },
...
var HRV_LABEL_ALIAS = {
  'resting hr':'hrRest', 'resting hr (bpm)':'hrRest', 'rest hr':'hrRest', 'resting heart rate':'hrRest',
  'rmssd':'rmssd', 'sdnn':'sdnn', 'lf/hf':'lfhf', 'hf n.u.':'hfnu', 'hf nu':'hfnu',
  'sd1/sd2':'sd1sd2', 'baevsky si':'si', 'toichi cvi':'cvi', 'toichi csi':'csi',
  'dfa α1':'dfaAlpha1', 'dfa a1':'dfaAlpha1', 'spectral ent':'spectralEnt',
  'sdnn z-score':'sdnnZ', 'sdnn z':'sdnnZ', 'hrv momentum':'momentum',
  'vei (rmssd/hr)':'vei', 'vei':'vei', 'cai':'cai',
  'hrv score':'hrvScore', 'stress':'stress', 'energy':'energy', 'coherence':'coherence',
  'ans load':'ansLoad', 'recov index':'recovIndex', 'recovery':'recovIndex', 'recov debt':'recovDebt',
  'efc index':'efc', 'efc readiness':'efc', 'abs':'abs', 'autonomic balance score':'abs',
  'welfare idx':'welfare', 'welfare index':'welfare', 'restoration index':'welfare', 'pti':'pti',
  'overtrain risk':'otr', 'otr index':'otr', 'otr index (capped 500)':'otr',
  'cardiac resilience':'crs', 'cardiac resilience score':'crs', 'resilience':'crs',
  'focus efficiency':'focusEff', 'focus eff':'focusEff',
  'pns efficiency':'pnsEff', 'pns eff':'pnsEff',
  'orthostatic load':'ortho', 'orthostatic load (hr/sdnn)':'ortho', 'camq':'camq',
  'vo2max est':'vo2', 'vo₂max est':'vo2',
  'vo2 7d avg':'vo2roll', 'vo₂ 7d avg':'vo2roll'
};
...
global.HrvRegistry = {
  REGISTRY: HRV_REGISTRY, ALIAS: HRV_LABEL_ALIAS,

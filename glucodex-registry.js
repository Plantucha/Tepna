...
(function (global) {
  ...
  var GLU_REGISTRY = {
    ...
    warmup: {
      label: 'Warm-up suppressed',
      unit: 'min',
      goodDirection: 'down',
      depth: 'research',
      evidence: 'measured',
      cite: 'Fresh-sensor warm-up minutes suppressed from analysis — direct coverage'
    },
    sessionSpread: {
      label: 'Between-session spread',
      unit: 'mg/dL',
      goodDirection: 'down',
      depth: 'advanced',
      evidence: 'measured',
      cite: 'Range of per-session medians — direct between-sensor step statistic'
    },
  ...
  var GLU_LABEL_ALIAS = {
    ...
    sd: 'sd',
    mag: 'mag',
    '% sensor active': 'pctActive',
    'sensor active': 'pctActive',
    'active duration': 'duration',
    duration: 'duration',
    'compression flagged': 'compression',
    'compression lows': 'compression',
    'active time': 'duration',
    'warm-up suppressed': 'warmup',
    'between-session spread': 'sessionSpread',
    'largest drift': 'sessionDrift',
    'data confidence': 'dataConf',
    'nocturnal hypo': 'nocHypo',
    'nocturnal hypos': 'nocHypo',
    ...
    'tar 181-250': 'tar1',
    'tar >250': 'tar2',
    'time below': 'timeBelow',
    'time above': 'timeAbove',
    mage: 'mage',
    modd: 'modd',
    conga: 'conga',
    'conga-1h': 'conga',
    ...
    'bσ(lnrmssd) slope': 'lnrmssdSlope',
    'stability score': 'stability',
    'ir-risk band': 'irBand',
    'autonomic risk': 'autoRisk',
    'glycemic variability': 'glyVar',
    'hypo⟷qtc risk': 'hypoQtc',
    'gmi vs lab': 'gmiVsLab',
    'gmi vs lab a1c': 'gmiVsLab',
    'sensor bias vs lab a1c': 'sensorBias'
  };
  ...
  function idForLabel(label) {
    ...
    if (GLU_LABEL_ALIAS[k]) return GLU_LABEL_ALIAS[k];
    ...
    if (!_labelIdx) {
      _labelIdx = {};
      for (var _lk in GLU_REGISTRY) {
        var _le = GLU_REGISTRY[_lk];
        if (_le && _le.label) {
  ...
  global.GlucoRegistry = {
    REGISTRY: GLU_REGISTRY,
    ALIAS: GLU_LABEL_ALIAS,

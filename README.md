...
[![Suite v2.12.0](https://img.shields.io/badge/suite-v2.12.0-2a6fdb?style=for-the-badge)](CHANGELOG.md)
...
![Releases](https://img.shields.io/badge/releases-38_shipped-555)
...
**Suite version:** 2.12.0 &nbsp;—&nbsp; **38** ledger-backed releases, each computed from a green tree, with **0 changesets** pending since (the tree is exactly the release).
...
| 🧪 **Tests** | **9,477 assertions** across **609 groups**, run as **6 partitioned CI shards** — green on every push |
...
> scanning drops from a 50 % duty to 8–17 % when nothing is near) and a **restart-storm hold** after a
> night in which the ring was reset **520 times** (quiet nights: 1–2). The ring's lossless `0x03`

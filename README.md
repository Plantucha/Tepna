...
[![Suite v2.6.0](https://img.shields.io/badge/suite-v2.6.0-2a6fdb?style=for-the-badge)](CHANGELOG.md)
...
![Releases](https://img.shields.io/badge/releases-32_shipped-555)
...
**Suite version:** 2.6.0 &nbsp;—&nbsp; **32** ledger-backed releases, each computed from a green tree.

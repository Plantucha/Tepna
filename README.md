...
| **tests** | ~1,900 assertions over the real DSP modules + render coverage |
| **types** | JSDoc type-checking across the signal contracts |
| **lint** | House invariants (frozen names, Clock Contract, SPDX, evidence vocabulary) |
...
| You want… | Look at |
|---|---|
| **A map of every doc** | [`DOCS-INDEX.md`](DOCS-INDEX.md) — the single entry path over all ~160 briefs, audits, and READMEs, grouped by topic. Start here before opening any individual brief. |

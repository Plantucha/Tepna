...
Max information, minimum hardware, priced honestly. Every signal in the suite comes off this kit
(approximate US street prices, August 2026; the box was bought **used**):

| Hardware | Role | Approx. price |
|---|---|---:|
| **Lenovo ThinkCentre M900 Tiny** (refurbished — any 6th-gen-i5 tiny works) | the Health Box — 24/7 bedside capture daemon · LAN server · clock synced ±1 ms to the stratum-1 below | ~$80–130 |
...
| **CenterClick NTP250** GPS time server | LAN stratum-1 — the timing-integrity backbone every capture clock is disciplined against *(optional; NTP pool works at ms-accuracy)* | ~$200–240 *(current models: NTP220/NTP270)* |

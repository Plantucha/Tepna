...
[![Suite v2.11.0](https://img.shields.io/badge/suite-v2.11.0-2a6fdb?style=for-the-badge)](CHANGELOG.md)
...
![Releases](https://img.shields.io/badge/releases-37_shipped-555)
...
**Suite version:** 2.11.0 &nbsp;—&nbsp; **37** ledger-backed releases, each computed from a green tree, with **0 changesets** pending since (the tree is exactly the release).
...
| 🧪 **Tests** | **9,266 assertions** across **592 groups**, run as **6 partitioned CI shards** — green on every push |

...
[![Suite v2.0.0](https://img.shields.io/badge/suite-v2.0.0-2a6fdb?style=for-the-badge)](CHANGELOG.md)
...
![Releases](https://img.shields.io/badge/releases-26_shipped-555)
...
**Suite version:** 2.0.0 &nbsp;—&nbsp; **26** ledger-backed releases, each computed from a green tree.

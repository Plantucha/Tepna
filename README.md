...
[![Suite v2.8.0](https://img.shields.io/badge/suite-v2.8.0-2a6fdb?style=for-the-badge)](CHANGELOG.md)
...
[![Tests green](https://img.shields.io/badge/tests-8.3k_assertions_green-1f8a5b)](#-the-privacy-claim-is-a-test-not-a-promise)
...
![Releases](https://img.shields.io/badge/releases-34_shipped-555)
...
**Suite version:** 2.8.0 &nbsp;—&nbsp; **34** ledger-backed releases, each computed from a green tree.
...
| 🧪 **Tests** | **8,330 assertions** across **531 groups**, run as **6 partitioned CI shards** — green on every push |
| 🐍 **Capture lane** | the **Health Box** (`capture-host/`) — **4,700+ Python tests** at a **100 % statement *and* branch** coverage floor |
...
| **tests** | 8,330 assertions over the real DSP modules, run as 6 parallel shards that provably *partition* the suite — so the union of the shards is the whole gate, and no group can quietly go unrun |
...
across **4,700+ tests**. That floor is the point: this code runs unattended overnight against

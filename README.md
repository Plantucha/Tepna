...
- **[nglessner/o2ring-s-protocol](https://github.com/nglessner/o2ring-s-protocol)** — the OxyII (O2Ring-S) BLE protocol reference. Tepna's implementation was verified byte-for-byte against it on real hardware, and Tepna owes a finding back upstream: opcode `0x05` (listed there as "purpose unknown") is a 2-channel signed optical stream.

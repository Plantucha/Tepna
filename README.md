...
[![Suite v1.16.0](https://img.shields.io/badge/suite-v1.16.0-2a6fdb?style=for-the-badge)](CHANGELOG.md)
...
[![Tests green](https://img.shields.io/badge/tests-3.5k%2B_assertions_green-1f8a5b)](#-the-privacy-claim-is-a-test-not-a-promise)
...
![Releases](https://img.shields.io/badge/releases-22_shipped-555)
...
**Suite version:** 1.18.0 &nbsp;—&nbsp; **22** ledger-backed releases, each computed from a green tree.
...
| 🧪 **Tests** | **3,500+ assertions** across **230 groups**, run as **6 partitioned CI shards** — green on every push |
...
> **Momentum.** `v1.16.0` landed a fleet-wide **DEEP-AUDIT-II** hardening pass: cross-signal
> ECG↔apnea corroboration anchored to the right night, presence-gated HRV math (no more `null`
> arithmetic publishing confident numbers), and duration-scoped norms. Full history in the
...
| **tests** | 3,500+ assertions over the real DSP modules, run as 6 parallel shards that provably *partition* the suite — so the union of the shards is the whole gate, and no group can quietly go unrun |

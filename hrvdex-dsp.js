...
(function (root) {
  ...
  function computeDerived(rowsArg) {
    ...
    _rows.forEach((r, i, arr) => {
      ...
      r.d_bap = 0.011 * r._hr + 0.014 * AGE + 0.008 * _p.sbp + 0.014 * _p.dbp - 0.009 * _p.weight - 0.009 * _p.height - 0.27;
      ...
      r.d_welfare = r._energy > 0 && r._coherence > 0 ? (r._energy * r._coherence) / (r._stress + 1) : NaN;

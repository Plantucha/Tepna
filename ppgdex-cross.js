...
var PPG_DEFS = {
  ...
  pi:{ good:'up', label:'Perfusion Idx', unit:'%', evidence:'measured', get:function(s){ return s.perfusionIndex; } },
  ai:{ good:'down', label:'Aug. index', unit:'%', evidence:'emerging', get:function(s){ return s.morph?s.morph.augmentationIndexPct:null; } },
  motionRejected:{ good:'down', label:'Motion-rejected', unit:'%', evidence:'measured', get:function(s){ return s.motionRejectedPct; } }
};

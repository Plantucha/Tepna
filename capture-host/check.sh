...
# mypy flips BLOCKING at 0 errors (baseline 154, 2026-08-29; the number may only go DOWN); the
...
if "$PY" -c 'import mypy' 2>/dev/null; then
  run_advisory "mypy" "baseline 154 (2026-08-29) — count may only go DOWN; flips blocking at 0"     mypy_advisory
else

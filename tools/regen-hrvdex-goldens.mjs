...
const rerecord = makeRerecord({ repo: REPO, node: 'HRVDex', bundle: 'HRVDex.html', fixturesDir: UP, corpusDir: CORPUS, ManifestGate });
await runRegen({ fixtures: FIXTURES, fixturesDir: UP, corpusDir: CORPUS, check: CHECK, rerecord, absentInputHint: 'copy the Welltory HRV *.csv into uploads/ to regenerate' });

...
| acc-respiratory-rate | REAL (n-of-1) | n/a — generator-independent; 8,057 real epochs vs CPAP flow (restated 2026-09-07) | drafted | **DRAFT** ↓R2 (new, 2026-07-22) |
...
| known-clock-recovery | REAL (n-of-1, preregistered) | n/a — generator-independent; 61 BLE arrival streams + 101 RR trains + a paired ACC night over 21 nights (Draft v4, + beat-detector completeness) | done | **DONE** (new, 2026-08-14) ↓R4 |
